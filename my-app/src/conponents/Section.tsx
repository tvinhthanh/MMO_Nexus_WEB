      ...
      <div className="container mx-auto py-20 px-44 bg-gradient-to-b from-purple-100 to-blue-100">
        <div className="flex flex-col lg:flex-row items-center gap-10 mb-16">
          <div className="w-full lg:w-1/2">
            <img src="/image1.png" alt="Diverse Graphics, The Future Of Experience" className="w-full h-auto" />
          </div>
          <div className="w-full lg:w-1/2">
        ...
        <div className="flex flex-col lg:flex-row-reverse items-center gap-10 mb-16">
          <div className="w-full lg:w-1/2">
            <img src="/image2.png" alt="Fun To Earn Entertainment & Earn Income" className="w-full h-auto" />
          </div>
          <div className="w-full lg:w-1/2">
