      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-20 py-20 px-44">
        <div className="flex items-start space-x-4">
          <div className="text-left">
            <img src="/feature1.png" alt="Digital Credibility" className="w-20 h-20" />
        ...
        <div className="flex items-start space-x-4">
          <div className="text-left">
            <img src="/feature2.png" alt="KiNi World" className="w-20 h-20" />
        ...
        <div className="flex items-start space-x-4">
          <div className="text-left">
            <img src="/feature3.png" alt="Playou Together" className="w-20 h-20" />
        ...
        <div className="flex items-start space-x-4">
          <div className="text-left">
            <img src="/feature4.png" alt="Univer Beauty" className="w-20 h-20" />
        ...
        <div className="flex items-start space-x-4">
          <div className="text-left">
            <img src="/feature5.png" alt="Wibu Mirage" className="w-20 h-20" />
        ...
        <div className="flex items-start space-x-4">
          <div className="text-left">
            <img src="/feature6.png" alt="MMOLogin Solutions" className="w-20 h-20" />
